...
class RevogacaoIntelbrasTest extends TestCase
{
    use RefreshDatabase;
    ...
    /** @test */
    public function pode_remover_user_morador()
    {
       //_____________________Passo 1 - autorizacao ______________\\
       ...
       //Revogar autorizacao_____________________Passo 2 - Revogar autorizacao ______________\\
       ...
       $this->assertEquals(Morador::class, get_class($model_selected));
       $this->assertEquals($endpoint, 'remover_user');
