...
namespace Tests\Unit\Strategies\ControlID\CriarJobsRevogar;
...
class ControlIdCriarJobsRevogarStrategyTest extends TestCase
{
    use RefreshDatabase;
    ...
    /** @test */
    public function pode_criar_job_revogar_para_morador()
    {
        ...
        // Executar a autorização
        $response = $this->strategy->createJobByEndpoint($this->dispositivo, $this->morador, 'delete_user');
    ...
    /** @test */
    public function pode_criar_job_revogar_para_criar_visitante()
    {
        ...
        // Executar a autorização
        $response = $this->strategy->createJobByEndpoint($this->dispositivo, $this->visitante, 'delete_user');
    ...
    /** @test */
    public function nao_pode_criar_job_revogar_para_dispositivo_inativo()
    {
        ...
        // Executar a autorização
        $response = $this->strategy->createJobByEndpoint($this->dispositivoInativo, $this->morador, 'delete_user');
